...
import { Settings2, Trash2, Edit2, Type, Minus, MoreHorizontal, Lock, Unlock, GripVertical, LayoutGrid, Pencil, Plus, ChevronRight, Copy } from 'lucide-react';
      ...
      for (let i = 0; i < coordinates.length - 1; i++) {
        ...
        for (let s = 1; s < steps; s++) {
          ...
          figures.push({
            ...
            styles: {
              style: 'stroke_fill',
              color: isUp ? 'rgba(8, 153, 129, 0.3)' : 'rgba(242, 54, 69, 0.3)',
  ...
  useEffect(() => {
    ...
    if (activeTool === 'clear') {
      ...
      if (activeTool === 'highlighter') {
        ...
        overlayName = 'arrow';
      } else if (['rotatedRect', 'ellipse', 'path', 'polyline', 'arc', 'curve', 'doubleCurve', 'cypher', 'threeDrives', 'headAndShoulders'].includes(activeTool)) {
