...
export const FUNDAMENTAL_DATA: Record<string, FundamentalData> = {
  ...
  'FPT': {
    ...
    introduction: 'FPT là tập đoàn công nghệ hàng đầu Việt Nam, hoạt động trong 3 lĩnh vực cốt lõi: Công nghệ, Viễn thông và Giáo dục. Với mạng lưới toàn cầu, FPT tiên phong chuyển đổi số, phát triển phần mềm, tích hợp hệ thống và cung cấp dịch vụ CNTT cho nhiều khách hàng lớn trên thế giới.',
    issueDate: '2006-12-13',
    issuePrice: 'N/A',
    maxSupply: 'N/A',
    circulatingSupply: '1,459,963,732 Cổ phiếu',
    totalSupply: '1,459,963,732 Cổ phiếu',
    marketCap: '168,000 Tỷ VNĐ',
    website: 'https://fpt.com.vn/',
    explorer: 'https://finance.vietstock.vn/FPT-ctcp-fpt.htm'
  },
  'VCB': {
    symbol: 'VCB',
    name: 'Ngân hàng TMCP Ngoại thương Việt Nam',
    introduction: 'Vietcombank là một trong những ngân hàng thương mại lớn nhất Việt Nam. Được thành lập và đi vào hoạt động từ năm 1963, VCB có mạng lưới hoạt động rộng khắp trong nước và quốc tế, đóng vai trò quan trọng trong hệ thống ngân hàng, xuất nhập khẩu và thanh toán quốc tế.',
    issueDate: '2009-06-30',
    issuePrice: 'N/A',
    maxSupply: 'N/A',
    circulatingSupply: '5,589,091,262 Cổ phiếu',
    totalSupply: '5,589,091,262 Cổ phiếu',
    marketCap: '514,000 Tỷ VNĐ',
    website: 'https://portal.vietcombank.com.vn/',
    explorer: 'https://finance.vietstock.vn/VCB-ngan-hang-tmcp-ngoai-thuong-viet-nam.htm'
  },
  'HPG': {
    symbol: 'HPG',
    name: 'Công ty Cổ phần Tập đoàn Hòa Phát',
    introduction: 'Hòa Phát là Tập đoàn sản xuất công nghiệp hàng đầu Việt Nam. Khởi đầu từ một Công ty chuyên buôn bán các loại máy xây dựng từ tháng 8/1992, Hòa Phát lần lượt mở rộng sang Nội thất, Ống thép, Thép, Điện lạnh, Bất động sản và Nông nghiệp.',
    issueDate: '2007-11-15',
    issuePrice: 'N/A',
    maxSupply: 'N/A',
    circulatingSupply: '6,396,250,000 Cổ phiếu',
    totalSupply: '6,396,250,000 Cổ phiếu',
    marketCap: '195,000 Tỷ VNĐ',
    website: 'https://www.hoaphat.com.vn/',
    explorer: 'https://finance.vietstock.vn/HPG-ctcp-tap-doan-hoa-phat.htm'
  },
  'SSI': {
    symbol: 'SSI',
    name: 'Công ty Cổ phần Chứng khoán SSI',
    introduction: 'SSI là công ty chứng khoán lớn nhất và có uy tín nhất trên thị trường chứng khoán Việt Nam. SSI cung cấp các dịch vụ tài chính quy mô lớn, bao gồm Môi giới chứng khoán, Dịch vụ Ngân hàng đầu tư, Quản lý quỹ, và Dịch vụ tài chính doanh nghiệp.',
    issueDate: '2006-12-15',
    issuePrice: 'N/A',
    maxSupply: 'N/A',
    circulatingSupply: '1,511,100,000 Cổ phiếu',
    totalSupply: '1,511,100,000 Cổ phiếu',
    marketCap: '57,720 Tỷ VNĐ',
    website: 'https://www.ssi.com.vn/',
    explorer: 'https://finance.vietstock.vn/SSI-ctcp-chung-khoan-ssi.htm'
  },
  'VIC': {
    symbol: 'VIC',
    name: 'Tập đoàn Vingroup',
    introduction: 'Vingroup là tập đoàn tư nhân đa ngành lớn nhất Việt Nam, tiền thân là Tập đoàn Technocom thành lập năm 1993 tại Ukraina. Vingroup hoạt động trong 3 lĩnh vực cốt lõi: Công nghệ - Công nghiệp, Thương mại Dịch vụ (Bất động sản, Du lịch - Giải trí...), và Hoạt động Xã hội (Y tế, Giáo dục...).',
    issueDate: '2007-09-19',
    issuePrice: 'N/A',
    maxSupply: 'N/A',
    circulatingSupply: '3,823,600,000 Cổ phiếu',
    totalSupply: '3,823,600,000 Cổ phiếu',
    marketCap: '172,000 Tỷ VNĐ',
    website: 'https://vingroup.net/',
    explorer: 'https://finance.vietstock.vn/VIC-tap-doan-vingroup-ctcp.htm'
  },
