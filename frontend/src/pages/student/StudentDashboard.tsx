...
export const StudentDashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Good afternoon, {user?.name || 'Student'}</h1>
        <p className="text-slate-500 dark:text-slate-400 mt-2 text-lg">Here's your trading overview and upcoming tasks.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-slate-200 dark:border-[#253047] shadow-sm dark:shadow-lg relative overflow-hidden group transition-colors">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 relative z-10">Portfolio Value</p>
          <h3 className="text-3xl font-bold text-slate-900 dark:text-white relative z-10">{MOCK_STUDENT_PORTFOLIO.totalValue.toLocaleString('vi-VN')} ₫</h3>
          <div className="mt-4 flex items-center gap-2 relative z-10">
            <span className="flex items-center text-xs font-semibold text-emerald-600 dark:text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded">
        ...
        <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-slate-200 dark:border-[#253047] shadow-sm dark:shadow-lg relative overflow-hidden group transition-colors">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 relative z-10">Win Rate</p>
          <h3 className="text-3xl font-bold text-slate-900 dark:text-white relative z-10">{MOCK_STUDENT_PORTFOLIO.winRate}%</h3>
          <div className="mt-4 flex items-center gap-2 relative z-10">
        ...
        <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-slate-200 dark:border-[#253047] shadow-sm dark:shadow-lg relative overflow-hidden group transition-colors">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 relative z-10">Avg. Profit / Loss</p>
          <h3 className="text-3xl font-bold text-slate-900 dark:text-white relative z-10">{MOCK_STUDENT_PORTFOLIO.profitFactor}x</h3>
          <div className="mt-4 flex items-center gap-2 relative z-10">
        ...
        <div className="bg-white dark:bg-[#111827] p-6 rounded-2xl border border-slate-200 dark:border-[#253047] shadow-sm dark:shadow-lg relative overflow-hidden group transition-colors">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1 relative z-10">Active Tasks</p>
          <h3 className="text-3xl font-bold text-slate-900 dark:text-white relative z-10">{upcomingAssignments.length}</h3>
          <div className="mt-4 flex items-center gap-2 relative z-10">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#111827] rounded-2xl border border-slate-200 dark:border-[#253047] shadow-sm dark:shadow-lg p-6 transition-colors">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-bold text-slate-900 dark:text-white">Upcoming Assignments</h2>
              <Link to="/student/assignments" className="text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition-colors">
                View All
              </Link>
            </div>
            <div className="space-y-4">
              {upcomingAssignments.map(assignment => (
                <Link key={assignment.id} to={`/student/assignments/${assignment.id}`} className="block group">
                  <div className="p-4 rounded-xl border border-slate-200 dark:border-[#253047] bg-slate-50 dark:bg-[#172033] group-hover:border-indigo-500/50 transition-colors">
                    ...
                    <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{assignment.title}</h4>
