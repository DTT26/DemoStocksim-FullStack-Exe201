...
import { LayoutDashboard, Target, BookOpen, Users, Activity, User, LogOut, TrendingUp, Menu, LineChart } from 'lucide-react';
    ...
    <>
      ...
      <aside className={sidebarClasses}>
        <div className="flex items-center justify-between h-16 px-4 border-b border-[#e2e8f0] dark:border-[#253047]">
          {!collapsed && (
            <Link to="/lecturer" className="flex items-center gap-2 px-2">
          ...
          {collapsed && (
            <Link to="/lecturer" className="mx-auto flex items-center justify-center w-10 h-10 rounded-lg bg-indigo-600 shadow-sm">
